...
//     try {
//       const response = await fetch('https://anish-cognitech.onrender.com/api/all/all-courses');
...
//     try {
//       const response = await fetch(`https://anish-cognitech.onrender.com/api/admin-d/delete-course/${courseId}`, {
//         method: 'DELETE',
//       });
...
const AdminCourseManage = () => {
  ...
  const confirmDelete = async () => {
    ...
    try {
      const response = await fetch(`https://anish-cognitech.onrender.com/api/admin-d/delete-course/${courseToDelete}`, {
        method: 'DELETE',
      });
