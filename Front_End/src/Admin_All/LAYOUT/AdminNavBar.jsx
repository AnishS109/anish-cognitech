...
import { AppBar, Box, Button, Toolbar, Typography, IconButton, Drawer, Divider, Dialog, DialogActions, DialogContent, DialogTitle } from "@mui/material";
  ...
  const drawer = (
    <Box onClick={handleDrawerToggle} className="drawer-container">
      ...
      <ul className="drawer-options">
        <li>
          <NavLink activeClassName="active" to="/admin-dashboard">Home</NavLink>
        </li>
        <li>
          <NavLink activeClassName="active" to="/admin-user-manage">User Manage</NavLink> {/* Added User Manage */}
        </li>
        <li>
          ...
          <Toolbar sx={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            ...
            <Box sx={{ display: { xs: "none", md: "flex" }, alignItems: "center" }}>
              <ul className='navbar-options'>
                ...
                <li>
                  <NavLink activeClassName="active" to="/admin-user-manage">User Manage</NavLink>
                </li>
                <li>
